 ...
 * Tests the real-time notification functionality using the actual running server
 */
...
async function testNotificationCreation() {
    try {
        ...
        const notification = new Notification({
            ...
            message: 'This notification was created in the live database',
            relatedEntity: {
                entityType: 'user',
...
async function runTests() {
    try {
        console.log('🚀 Starting Live Notification Tests...\n');
