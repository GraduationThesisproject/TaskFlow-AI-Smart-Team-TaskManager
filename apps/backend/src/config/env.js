...
module.exports = {
  ...
  // Frontend URL
  FRONTEND_URL: process.env.FRONTEND_URL || 'http://localhost:5173'||'http://10.208.47.13:8081',
  ...
  CORS_ORIGIN: process.env.CORS_ORIGIN ? process.env.CORS_ORIGIN.split(',').map(origin => origin.trim()) : [
    ...
    'http://localhost:5175',
    'http://localhost:5176',
    'http://10.208.47.13:8081', // Expo dev server
    'http://10.208.47.13:3001', // Mobile app direct connection
    'http://10.208.47.13:3001', // Alternative network IP
    'http://10.208.47.13:8081', // Alternative Expo dev server
    'exp://10.208.47.13:8081', // Expo protocol
    'exp://10.208.47.13:8081', // Alternative Expo protocol
