...
const Sidebar = () => {
  ...
  const displayName =
    ...
    'Your';
  return (
    <aside className="h-ful w-60 border-r border-border bg-[hsl(var(--neutral-200))] 
             ring-1 ring-primary/20 
             backdrop-blur bg-background" >
      <div className="flex flex-col gap-3 p-4 ">
         {/* Section title */}
         <h3 className="px-2 text-[13px] font-medium tracking-wide" style={{color: "hsl(var(--accent))"}}>Workspace</h3>
         ...
         <div className="bg-background rounded-xl p-3 
           ...
           <div className="flex items-center gap-3" >
             <div className="flex h-9 w-9 items-center justify-center rounded-full" style={{background: 'linear-gradient(90deg, hsl(var(--info)) 0%, hsl(var(--accent)) 100%)'}}>
             <svg width="10" height="16" viewBox="0 0 10 16" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M9.84375 16H0.84375V0H9.84375V16Z" stroke="white"/>
...
<g clipPath="url(#clip0_222_439)">
<path d="M6 0C4.69375 0 3.58125 0.834375 3.17188 2H2C0.896875 2 0 2.89687 0 4V14C0 15.1031 0.896875 16 2 16H10C11.1031 16 12 15.1031 12 14V4C12 2.89687 11.1031 2 10 2H8.82812C8.41875 0.834375 7.30625 0 6 0ZM6 2C6.26522 2 6.51957 2.10536 6.70711 2.29289C6.89464 2.48043 7 2.73478 7 3C7 3.26522 6.89464 3.51957 6.70711 3.70711C6.51957 3.89464 6.26522 4 6 4C5.73478 4 5.48043 3.89464 5.29289 3.70711C5.10536 3.51957 5 3.26522 5 3C5 2.73478 5.10536 2.48043 5.29289 2.29289C5.48043 2.10536 5.73478 2 6 2ZM3.5 6H8.5C8.775 6 9 6.225 9 6.5C9 6.775 8.775 7 8.5 7H3.5C3.225 7 3 6.775 3 6.5C3 6.225 3.225 6 3.5 6ZM6.84375 7.125C6.84375 6.91875 7.0125 6.75 7.21875 6.75H7.96875C8.175 6.75 8.34375 6.91875 8.34375 7.125V7.875C8.34375 8.08125 8.175 8.25 7.96875 8.25H7.21875C7.0125 8.25 6.84375 8.08125 6.84375 7.875V7.125ZM2.71875 3.75H3.46875C3.675 3.75 3.84375 3.91875 3.84375 4.125V4.875C3.84375 5.08125 3.675 5.25 3.46875 5.25H2.71875C2.5125 5.25 2.34375 5.08125 2.34375 4.875V4.125C2.34375 3.91875 2.5125 3.75 2.71875 3.75ZM4.59375 4.125C4.59375 3.91875 4.7625 3.75 4.96875 3.75H5.71875C5.925 3.75 6.09375 3.91875 6.09375 4.125V4.875C6.09375 5.08125 5.925 5.25 5.71875 5.25H4.96875C4.7625 5.25 4.59375 5.08125 4.59375 4.875V4.125ZM7.21875 3.75H7.96875C8.175 3.75 8.34375 3.91875 8.34375 4.125V4.875C8.34375 5.08125 8.175 5.25 7.96875 5.25H7.21875C7.0125 5.25 6.84375 5.08125 6.84375 4.875V4.125C6.84375 3.91875 7.0125 3.75 7.21875 3.75Z" fill="hsl(var(--primary))"/>
</g>
<defs>
<clipPath id="clip0_222_439">
<path d="M0 0H12V16H0V0Z" fill="hsl(var(--primary))"/>
</clipPath>
</defs>
</svg>
            ...
            <li>
              <NavLink
                ...
                className={({ isActive }) =>
                  isActive
                    ? 'mx-1 flex items-center gap-3 rounded-xl border border-accent/30 bg-accent/20 px-3 py-2 text-sm shadow-[0_0_0_1px_rgba(0,232,198,0.15),_0_8px_30px_-12px_rgba(0,232,198,0.35)] ring-1 ring-accent/30'
                    : 'group mx-1 flex items-center gap-3 rounded-lg px-3 py-2 text-sm hover:bg-muted/30 hover:text-foreground transition-colors'
                }
              >
...
<path d="M0 0H12V16H0V0Z" fill="hsl(var(--primary))"/>
            ...
            <li>
              ...
              >
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M16 16H0V0H16V16Z" stroke="hsl(var(--primary))"/>
<path d="M2 2C2 1.44687 1.55313 1 1 1C0.446875 1 0 1.44687 0 2V12.5C0 13.8813 1.11875 15 2.5 15H15C15.5531 15 16 14.5531 16 14C16 13.4469 15.5531 13 15 13H2.5C2.225 13 2 12.775 2 12.5V2ZM14.7063 4.70625C15.0969 4.31563 15.0969 3.68125 14.7063 3.29063C14.3156 2.9 13.6812 2.9 13.2906 3.29063L10 6.58437L8.20625 4.79063C7.81563 4.4 7.18125 4.4 6.79063 4.79063L3.29063 8.29062C2.9 8.68125 2.9 9.31563 3.29063 9.70625C3.68125 10.0969 4.31563 10.0969 4.70625 9.70625L7.5 6.91563L9.29375 8.70938C9.68437 9.1 10.3188 9.1 10.7094 8.70938L14.7094 4.70937L14.7063 4.70625Z" fill="hsl(var(--primary))"/>
</svg>
