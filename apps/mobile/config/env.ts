...
export const env = {
  ...
  API_BASE_URL: process.env.EXPO_PUBLIC_API_BASE_URL || Constants.expoConfig?.extra?.apiBaseUrl || (undefined as any),
  API_URL: process.env.EXPO_PUBLIC_API_URL || Constants.expoConfig?.extra?.apiUrl || (undefined as any),
  SOCKET_URL: process.env.EXPO_PUBLIC_SOCKET_URL || Constants.expoConfig?.extra?.socketUrl || (undefined as any),
  
  // App Configuration
  APP_NAME: Constants.expoConfig?.name || 'TaskFlow',
  APP_VERSION: Constants.expoConfig?.version || '1.0.0',
  BASE_URL: process.env.EXPO_PUBLIC_BASE_URL || Constants.expoConfig?.extra?.baseUrl || 'http://10.208.47.13:3001',
