...
export const env = {
  ...
  // API Configuration
  API_BASE_URL: process.env.EXPO_PUBLIC_API_BASE_URL || Constants.expoConfig?.extra?.apiBaseUrl || 'http://192.168.186.1:3001/api',
  API_URL: process.env.EXPO_PUBLIC_API_URL || Constants.expoConfig?.extra?.apiUrl || 'http://192.168.186.1:3001/api',
  SOCKET_URL: process.env.EXPO_PUBLIC_SOCKET_URL || Constants.expoConfig?.extra?.socketUrl || 'http://192.168.186.1:3001',
  
  // App Configuration
  APP_NAME: Constants.expoConfig?.name || 'TaskFlow',
  APP_VERSION: Constants.expoConfig?.version || '1.0.0',
  BASE_URL: process.env.EXPO_PUBLIC_BASE_URL || Constants.expoConfig?.extra?.baseUrl || 'http://192.168.186.1:3001',
